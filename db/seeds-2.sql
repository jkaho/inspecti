...
VALUES (1, "Bob", "Dylan", "bobby@email.com", "$2a$10$jEObUXD8pZmIith9StjiFOkJMBPpIfk4Y22jXwTrPgJooQZGwQEjK", "2020-10-07 04:04:11", "2020-10-07 04:04:11");

INSERT INTO users (id, firstName, lastName, email, password, createdAt, updatedAt)
VALUES (2, "Sally", "Jackson", "sally@email.com", "$2a$10$XWTDualRScH7dbEZd4rN7.xIVDrURLkxScR5Mj5CKrSz/KjQ4/tWe", "2020-10-13 08:14:27", "2020-10-13 08:14:27");

INSERT INTO users (id, firstName, lastName, email, password, createdAt, updatedAt)
VALUES (3, "Grace", "Lee", "grace@email.com", "$2a$10$vt0S5/Z30uTANXEviPi/geN01ipA1XLjs6jhspo8SXDkAToCZJsIy", "2020-11-03 15:42:03", "2020-11-03 15:42:03");

INSERT INTO users (id, firstName, lastName, email, password, createdAt, updatedAt)
VALUES (4, "Michael", "Wang", "michael@email.com", "$2a$10$fVROFrOUeZHXowkv2HxNL.oWF9EdYQrX2D3Gf6ot1hRutF2OR8x/m", "2020-11-27 12:55:58", "2020-11-27 12:55:58");
